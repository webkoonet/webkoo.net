        ...
        <div class="flex items-center justify-between h-16 px-6 lg:px-8">
            ...
            <div class="flex items-center gap-3 shrink-0">
                ...
                <a href="https://wa.me/6285179995773"
                   ...
                   class="flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-full bg-white text-gray-900 hover:bg-gray-50 transition-colors shadow-sm border border-gray-200">
